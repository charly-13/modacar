<!doctype html>
    ...
    <head>
        ...
        <link rel="shortcut icon" href="<?= media() ?>/tienda/img/favicon.png" type="image/x-icon">
        <!-- fonts -->
        ...
        <link rel="stylesheet" href="<?= media() ?>/tienda/css/vendor.css">
...
<li class="menu-list-item nav-item-sub">
    ...
    href="collection-left-sidebar.html">
    <img class="menu-img" src="<?= media() ?>/tienda/img/menu/1.jpg" alt="img">
