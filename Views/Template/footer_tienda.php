                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="/"><img src="<?= media() ?>/tienda/img/logo-accent.png" alt="bisum"></a>
                                    </h4>
                                    ...
                                    <div class="product-img-large">
                                        <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                                            ...
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/39.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/38.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/37.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/36.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/34.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/30.jpg" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="<?= media() ?>/tienda/img/products/bags/32.jpg" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="product-details ps-lg-4">
                                    ...
                                    <div class="misc d-flex align-items-end justify-content-between mt-4">
                                        <div class="quantity d-flex align-items-center justify-content-between">
                                            <button class="qty-btn dec-qty"><img src="<?= media() ?>/tienda/img/icon/minus.svg" alt="minus"></button>
                                            <input class="qty-input" type="number" name="qty" value="1" min="0">
                                            <button class="qty-btn inc-qty"><img src="<?= media() ?>/tienda/img/icon/plus.svg" alt="plus"></button>
                                        </div>
        ...
        <!-- all js -->
        <script src="<?= media() ?>/tienda/js/vendor.js"></script>
