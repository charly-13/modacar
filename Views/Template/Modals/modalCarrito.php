                    ...
                    <div class="minicart-loop custom-scrollbar">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="<?= media() ?>/tienda/img/products/furniture/1.jpg" alt="img">
                            </div>
                            <div class="product-info">
                                ...
                                <div class="misc d-flex align-items-end justify-content-between">
                                    <div class="quantity d-flex align-items-center justify-content-between">
                                        <button class="qty-btn dec-qty"><img src="<?= media() ?>/tienda/img/icon/minus.svg"
                                                alt="minus"></button>
                                        <input class="qty-input" type="number" name="qty" value="1" min="0">
                                        <button class="qty-btn inc-qty"><img src="<?= media() ?>/tienda/img/icon/plus.svg"
                                                alt="plus"></button>
                                    </div>
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="<?= media() ?>/tienda/img/products/furniture/2.jpg" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="<?= media() ?>/tienda/img/products/furniture/3.jpg" alt="img">
                            </div>
                            <div class="product-info">
                        ...
                        <div class="minicart-item d-flex">
                            <div class="mini-img-wrapper">
                                <img class="mini-img" src="<?= media() ?>/tienda/img/products/furniture/4.jpg" alt="img">
                            </div>
                            <div class="product-info">
                                <h2 class="product-title"><a href="#">Vita Lounge Chair</a></h2>
                                <p class="product-vendor">XS / Dove Gray</p>
